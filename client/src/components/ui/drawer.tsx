...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "yesfixed yesinset-x-0 yesbottom-0 yesz-50 yesmt-24 yesflex yesh-auto yesflex-col yesrounded-t-[10px] yesborder yesborder-slate-200 yesbg-white dark:yesborder-slate-800 dark:yesbg-slate-950",
        className
      )}
      {...props}
    >
      <div className="yesmx-auto yesmt-4 yesh-2 yesw-[100px] yesrounded-full yesbg-slate-100 dark:yesbg-slate-800" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
))
